...
export const updateProject = (id, body, token) => projectApi.patch(`/updateProject/${id}`,body, addToken(token));
export const createProject = (id, body, token) => projectApi.post(`/leader/assignProject/${id}`, body, addToken(token));
export const removeProject = (id, token) => projectApi.delete(`/leader/removeProject/${id}`, addToken(token));