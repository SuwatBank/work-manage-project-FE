  ...
  return (
    <>
      <li className='list-none grid grid-cols-6 gap-4 border mb-4 p-4 rounded-xl drop-shadow-2xl'>
        ...
        <Link className="btn btn-warning mr-2 col-start-4 col-end-5" to={`updateUser/${user.id}`}><button>Edit</button></Link>
        ...
        <div className="modal-box">
          <div className='flex flex-col items-center'>
            ...
            <div className="flex flex-row gap-10 justify-center">
              <button className='border p-3 rounded-xl bg-success border-success cursor-pointer font-bold text-white hover:text-black hover:bg-green-100 hover:border-green-100' onClick={() => onDelete(user.id)}>Confirm</button>
